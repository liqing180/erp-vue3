...
<script>
import { queryCompetitorList } from '@/api/competitor/index'
  ...
  data() {
    ...
    return {
      ...
      searchData: [
        {
          name: 'condition',
          placeholder: `${vm.$t('customer.competitorName')} / ${vm.$t('customer.code')}`,
          type: 'InputEle'
        }
      ],
      customColumns: [],
