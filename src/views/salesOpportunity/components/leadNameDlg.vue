  ...
  >
    ...
    <template v-slot:footer>
      <div class="dialog-footer">
        ...
        <el-button type="primary" @click="submitForm" v-if="false">{{
          $t('uiBtn.add')
        }}</el-button>
      </div>
    </template>
...
<script>
import { queryCanSelectLeadList } from '@/api/salesOpportunity/salesOpportunity'
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true
      queryCanSelectLeadList({}).then(res => {
        this.loading = false
