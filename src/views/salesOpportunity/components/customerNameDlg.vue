...
<script>
import { queryCanSelectCustomerList } from '@/api/salesOpportunity/salesOpportunity'
...
export default {
  ...
  data() {
    ...
    return {
      ...
      searchData: [
        {
          name: 'condition',
          placeholder: `${vm.$t('customer.customerName')} / ${vm.$t('customer.code')}`,
          type: 'InputEle'
        }
      ],
      customColumns: [],
  ...
  methods: {
    ...
    getList() {
      ...
      queryCanSelectCustomerList(params).then(response => {
