<template>
  <el-dialog
    ...
    draggable
    :title="$t('customer.salesOpportunity')"
    v-model="visible"
    width="1100px"
    top="5vh"
    append-to-body
...
<script>
import { queryLikeSalesOpportunityList, saveLead } from '@/api/leads/leads'
  ...
  data() {
    ...
    return {
      ...
      searchData: [
        {
          name: 'condition',
          placeholder: `${vm.$t('customer.salesOpportunityName')} / ${vm.$t('customer.code')}`,
          type: 'InputEle'
        }
      ],
      customColumns: [],
