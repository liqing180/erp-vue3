  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          type="primary"
          v-hasPermi="['customerManagement:customer:add']"
          icon="Plus"
          @click="handleAdd"
          size="small"
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="small"
          @click="handleImport"
          v-hasPermi="['customerManagement:customer:import']"
      ...
      <el-col :span="1.5">
        <el-button
          ...
          @click="openExport"
          v-hasPermi="['customerManagement:customer:export']"
    ...
    >
      <el-table-column
        v-if="
          checkPermi([
            'customerManagement:customer:assignTo',
            'customerManagement:customer:export'
          ])
        "
        type="selection"
        width="50"
...
export default {
  ...
  data() {
    ...
    return {
      ...
      importOptions: {
        // 下载模板
        downFileUrl: '/customer/downTemplate',
        // 上传校验
        uploadUrl:
          import.meta.env.VITE_APP_BASE_API + '/customer/checkImportData',
        // 提交导入
        importUrl: '/customer/importData',
        // 下载文件名
        fileName: 'Customer'
      },
      // 查询参数
      ...
      searchData: [
        {
          name: 'condition',
          type: 'InputEle',
          placeholder: `${vm.$t('customer.customerName')} / ${vm.$t(
            'customer.code'
          )}`
        },
        {
  ...
  methods: {
    ...
    querySearchList() {
      querySearchList({ customerType: '2' }).then(res => {
        const data = res.data || {}
