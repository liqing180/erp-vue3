              ...
              <el-row>
                ...
                <el-col :span="8">
                  <el-form-item :label="`${$t('SALES.salesGroupCode')}`">
                    <el-input
                      v-model="createForm.salesGroupNo"
                      class="form-wd"
                      disabled
                    />
                  </el-form-item>
...
import {
  saveSalesGroup,
  querySalesGroupCanSelectDepartmentList
...
export default {
  ...
  created() {
    ...
    this.querySalesGroupCanSelectDepartmentList()
  },
  activated() {
  ...
  methods: {
    // 查可以选择的上一级
    querySalesGroupCanSelectDepartmentList() {
      querySalesGroupCanSelectDepartmentList({}).then(res => {
