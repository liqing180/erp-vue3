  ...
  <el-collapse v-model="activeNames">
    ...
    <div class="form-card">
      <el-collapse-item name="1">
        ...
        <el-form ref="form1" :model="form" :rules="rules" label-width="180px">
          <el-row>
            <el-col :span="8">
              <el-form-item
            ...
            >
              <el-form-item :label="`${$t('SALES.taxRate')}`" prop="taxRate">
                <CommonSelect
                  ...
                  :title="$numberStr(form.taxRate, 1)"
                  idKey="taxRateStr"
                  labelKey="taxRateStr"
    ...
    <!-- 产品信息 -->
    <div class="form-card mt5 collapse-item-content-pt0">
...
export default {
  ...
  computed: {
    ...
    printPDFShow() {
      return this.buttonAuthMsg.isCanPrintPDF === '1'
    },
    reviseBtnShow() {
      return (
  ...
  methods: {
    ...
    contactPersonChange(row) {
      this.form.bpBusinessContactPersonId = row.businessContactPersonId
      ...
      this.$modal
        ...
        .then(response => {
          ...
          this.$modal.msgSuccess(
            successMsg.replace('$1', resData.salesQuotationNo)
          )
