<template>
  <div class="my-upload-file-warp">
    <el-form>
      ...
      >
        <div class="item-left">
          <span class="mr10" v-if="isView">{{ $t('ui.attachment') }} : </span>
          <span
            class="fileName"
          ...
          >
            ...
            <span
              class="primary-pointer ml10"
              v-if="!disabled && !file.disCancel && !isView"
              type="text"
              @click="delFile(file)"
              >{{ $t('uiBtn.delete') }}
            </span>
        ...
        <div class="item-right" v-show="file.status === 'success'" v-if="false">
