        ...
        <el-row :gutter="20" style="width: 100%">
          ...
          <el-col :span="7">
            <el-select
              ...
              clearable
              @change="updateOperator($event, index)"
            >
              <el-option
                v-for="child in operatorList"
                :key="child.type"
                :label="child.type"
                :value="child.type"
              >
...
export default {
  ...
  data() {
    return {
      ...
      operatorList: [{ type: 'contains' }, { type: 'in' }, { type: 'between' }]
    }
  },
  mounted() {},
  methods: {
    ...
    updateOperator(e, index) {
      console.log(e, index, '===338')
    },
    // 组件值变化时触发
